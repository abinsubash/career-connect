...
export default function SignupPage() {
  ...
  const inputBase = (field) =>
    `relative rounded-xl border-2 transition-all duration-200 ${
      focused === field ? "border-blue-500 shadow-sm shadow-blue-100" : "border-slate-200"
    }`;
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 px-6 pt-5 pb-6 relative overflow-hidden">
              ...
              <p className="text-blue-200 text-xs font-medium mb-0.5 relative z-10 tracking-widest uppercase">Get started</p>
            ...
            <div className="px-6 py-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className={inputBase("name")}>
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-transparent text-slate-800 placeholder-slate-400 text-sm outline-none"
                        required
                      />
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className={inputBase("password")}>
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-transparent text-slate-800 placeholder-slate-400 text-sm outline-none"
                      required
                    />
                ...
                <div>
                  ...
                  <div className={`relative rounded-xl border-2 transition-all duration-200 ${
                    passwordMismatch ? "border-red-400 shadow-sm shadow-red-100"
                    : passwordMatch ? "border-green-400 shadow-sm shadow-green-100"
                    : focused === "confirm" ? "border-blue-500 shadow-sm shadow-blue-100"
                    : "border-slate-200"
                  }`}>
                    <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white font-semibold py-3 rounded-xl transition-all duration-200 text-sm shadow-lg shadow-blue-200 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
              ...
              <p className="text-center text-sm text-slate-500 mt-4">
                ...
                <Link to ="/" className="text-blue-600 font-semibold hover:text-blue-700 hover:underline transition-colors">
                  Sign in
                </Link>
              </p>
            </div>
